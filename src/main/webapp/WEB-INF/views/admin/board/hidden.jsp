				...
				<div class="row justify-content-center">
					<div class="col-12  col-lg-10">
							...
							<div class="col">
								<ul class="nav nav-tabs border-0" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link "
										id="home-tab" href="${ pageContext.request.contextPath }/admin/board/list" role="tab" >최신순</a></li>
									<li class="nav-item"><a class="nav-link active" id="profile-tab"
										href="#home" role="tab">숨긴글</a></li>
								</ul>
							</div>
						</div>
						<!-- table -->
						...
						<table class="table table-borderless table-hover">
							...
							<tbody>
								<c:forEach items="${ hiddenlist }" var="boardVO" varStatus="loop">
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
								...
								<tr>
										...
										<td>
											<p class="mb-0 text-muted">I AM THE BEST !!!!!!!! YOU ARE ALL BAD!</p>
										</td>
										<td>
											<p class="mb-0 text-muted">shanghai101
										</td>
										<td class="text-muted"><small class="mb-0 text-muted">조회수:
												11</small><br> <small class="mb-0 text-muted">댓글수:
												0</small></td>
										<td>2020-10-02</td>
										<td>
											<button class="btn btn-sm dropdown-toggle more-horizontal"
								...
								<tr>
										...
										<td class="text-muted"><small class="mb-0 text-muted">조회수:
												1</small><br> <small class="mb-0 text-muted">댓글수:
												0</small></td>
										<td>2020-10-02</td>
										<td>
											<button class="btn btn-sm dropdown-toggle more-horizontal"
								...
								<tr>
										...
										<td class="text-muted"><small class="mb-0 text-muted">조회수:
												2</small><br> <small class="mb-0 text-muted">댓글수:
												0</small></td>
										<td>2020-10-02</td>
										<td>
											<button class="btn btn-sm dropdown-toggle more-horizontal"
