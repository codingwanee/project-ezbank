									...
									<tbody>
										<c:forEach items="${ list }" var="boardVO" varStatus="loop">
											<tr>
												...
												<td class="text-muted">
												<small class="mb-0 text-muted">조회수: ${ boardVO.viewCnt }</small><br>
												<small class="mb-0 text-muted">댓글수: ${ boardVO.cmtCnt }</small>
												</td>
												<td>
												${ boardVO.regDate }
												</td>
