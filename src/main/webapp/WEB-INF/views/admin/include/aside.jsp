        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="branch">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="${ pageContext.request.contextPath }/admin/branch/list"><span class="ml-1 item-text">지점목록</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="${ pageContext.request.contextPath }/admin/branch/register"><span class="ml-1 item-text">지점등록</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="${ pageContext.request.contextPath }/admin/branch/reservations"><span class="ml-1 item-text">예약현황</span></a>
                </li>
              </ul>
              </li>
            <li class="nav-item dropdown">
              <a href="#account" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">계좌</span>
              </a>
            ...
            <li class="nav-item dropdown">
              <a href="#certify" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                                <i class="fe fe-shield fe-16"></i>  <span class="ml-3 item-text">비대면 인증</span>
              </a>
			 <ul class="collapse list-unstyled pl-4 w-100" id="certify">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="${ pageContext.request.contextPath }/admin/certify/list"><span class="ml-1 item-text">인증신청목록</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./table_advanced.html"><span class="ml-1 item-text">Advanced Tables</span></a>
                </li>
...
<!--           <p class="text-muted nav-heading mt-4 mb-1">
          ...
          <div class="btn-box w-100 mt-4 mb-1">
            <a href="${ pageContext.request.contextPath }/" target="_blank" class="btn mb-2 btn-primary btn-lg btn-block">
              <i class="fe fe-home fe-16"></i><span class="small"> &nbsp;HanaEZ-UP 바로가기</span>
            </a>
          </div>
        </nav>
      </aside>