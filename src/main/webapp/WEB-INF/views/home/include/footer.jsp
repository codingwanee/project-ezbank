...
-->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-contact" data-aos="fade-up"
					...
					<h3>HanaEZ-UP</h3>
					<p>
						35 Euljiro,<br>  Jung-gu, Seoul <br> Republic of Korea<br>
						<strong>Phone:</strong> +82 1599-6111<br>(ext. 8 for foreign languages)<br>
	...
	<div class="container py-4">
		<div class="copyright">
			&copy; Copyright <strong><span>Hyewon Jeon</span></strong>. All Rights
			Reserved
		</div>
		<div class="credits">
			...
			Meet Hyewon At <a href="https://github.com/codingwanee">CODINGWANEE</a>
		</div>
	</div>
</footer>
<!-- End Footer -->
