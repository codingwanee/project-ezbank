	...
	<div id="wrapper">
		...
		<section id="branch-search"
			...
			<div
				...
				<div class="col-12">
					<h2 class="page-title">Easy-One Pack 예금 신규개설</h2>
					<p class="card-text">Easy-One Pack 예금 상품은 외국인 손님을 위한 전용 계좌입니다. </p>
										...
										<div class="row ">
											<div class="col-sm-12 ">
												<div>
													...
													<table class="table table-hanaform">
														<tr>
															<th>이름</th>
															<td>
																<div class="form-row">
														...
														<tr>
															...
															<td>
																<div class="form-row">
																	<div class="form-group col-md-4">
																		<input type="text" name="idNum1" class="form-control"
																			placeholder="" required>
																	</div>
																	<span>-</span>
																	<div class="form-group col-md-4">
																		<input type="text" name="idNum2" class="form-control"
																			placeholder="" required>
																	</div>
																</div>
													...
													<div class="row col-md-10 form-check form-check-inline p-3">
														<p class="p-3">
															<input type="checkbox" id="agree" name="agree"
																class="form-check-inline">
														</p>
														<label for="agree">휴대폰 본인인증 약관 동의</label>
														<button type="button" class="btn btn-outline-info"
															data-toggle="modal" data-target="#auth-sms-agree">서식보기</button>
													</div>
													<br>
													<table class="table table-hanaform">
														<tr>
														...
														<tr>
															<th>휴대폰번호</th>
															<td>
<%-- 																<form method="get" name="account-open"
																	action="${ pageContext.request.contextPath }/sms/send"> --%>
																	<div class="form-row">
																		...
																		<div class="form-group col-md-2">
																			<input class="form-control input-placeholder"
																				...
																				name="tel2" placeholder="" maxlength="4">
																		</div>
																		<div class="form-group col-md-2">
																			<input class="form-control input-placeholder"
																				id="custom-placeholder" type="text"
																				name="tel3" placeholder="" maxlength="4">
																		</div>
																		<div class="col-md-3">
																			<button onclick="javascript:smsTo(); return false;"
																			class="btn btn-outline-info">인증번호 요청</button>
																		</div>
																	</div>
																<!-- </form> -->
														...
														<tr>
															<th>인증번호입력</th>
															<td>
																<form method="post" name="authSms"
																	action="${ pageContext.request.contextPath }/account/open">
																	<div class="form-row">
																		<div class="form-group col-md-2">
																			<input type="text" name="authNum"
																				class="form-control" placeholder="선택입력">
																		</div>
																		<!-- 
																...
																<div>
																	<button class="btn btn-info"
																		onclick="javascript:goToEasyone(); return false;">인증하기</button>
																</div>
															</td>
														</tr>
													</table>
	...
	<!-- Modal -->
	<div class="modal fade" id="auth-sms-agree" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLongTitle" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">휴대폰 본인인증 약관</h5>
...
(시행일) 이 약관은 공시한 날로부터 시행합니다.
					...
					<strong>통신사 본인확인 이용 약관</strong><br>
...
(시행일) 이 약관은 공시한 날로부터 시행합니다.
	...
	<script>
		function smsTo() {
			...
			let smsTo = tel1 + tel2 + tel3;
				
			location.href = "${ pageContext.request.contextPath }/sms/sending/" + smsTo;
		}
	</script>
