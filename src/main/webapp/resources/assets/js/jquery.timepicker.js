"undefined" != typeof jQuery && function (c) {
    ...
    c.TimePicker = function () {
        ...
        keyCode: {
            ...
            var n = this, r = i.getTime(), e = i.options.dynamic && r;
            ...
            n.container.hasClass("ui-timepicker-no-scrollbar") || i.options.scrollbar || (n.container.addClass("ui-timepicker-no-scrollbar"), n.viewport.css({paddingRight: 40}));
            ...
            return n.ui.css({width: o}), n.viewport.css({width: o}), i.items.css({width: o}), n.instance = i, r ? i.items.each(function () {
                var e = c(this),
    ...
    }, c.TimePicker.methods = {chainable: ["next", "previous", "open", "close", "destroy", "setTime"]}, c.fn.timepicker = function (t) {
        if ("string" == typeof t) {
        ...
        var i = t.getHours(), n = i % 12, r = t.getMinutes(), a = t.getSeconds(), s = {
        ...
        var t, i, n = l(new Date), r = !1, a = !1, s = !1;
