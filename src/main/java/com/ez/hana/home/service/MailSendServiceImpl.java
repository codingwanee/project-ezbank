...
public class MailSendServiceImpl implements MailSendService {
	...
	public void sendMail(MailVO mailVO) {
		try {
            ...
            msg.addRecipient(RecipientType.TO, new InternetAddress(mailVO.getMailTo()));
            ...
            // 이메일 발신자
            msg.addFrom(new InternetAddress[] { new InternetAddress(mailVO.getMailFrom(), mailVO.getSenderName()) });
